    ...
    <header>
      <nav className="navbar navbar-expand-lg fixed-top navbar-dark bg-dark px-4">
        <div className="container-fluid">
          <a className="navbar-brand" href="/">毛小孩星球</a>
          ...
          <div className="collapse navbar-collapse" id="navbarCollapse">
            <ul className="navbar-nav ms-auto me-5 mb-2 mb-md-0">
              ...
              <li className="nav-item me-1">
                <a href="#activity" className="nav-link text-container">近期活動</a>
              </li>

              <li className="nav-item me-1">
                <a href="#album" className="nav-link text-container">狗兒相片</a>
              </li>

              <li className="nav-item me-1">
                <a href="#adoption" className="nav-link text-container">領養資訊</a>
              </li>
